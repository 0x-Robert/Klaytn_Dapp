...
//Bapp 에서 쓸수있는 전역 상수(DEPLOYED_ABI, DEPLOYED_ADDRESS)로 쓸 수 있게끔 웹팩에서 설정합니다.
...
const App = {
  ...
  callOwner: async function () {
    //우리가 만든 ag컨트랙 메소드에서 owner 함수에 접근해서 오너 값을 가져온다.
    //await을 써서 비동기로 가져옴
  ...
  getWallet: function () {
    //어떤 계정이 추가가되어있다면 길이가 있다면 첫번째 인덱스 값을 가져옵니다.
  ...
  integrateWallet: function (privateKey) {
    ...
    //walletInstance에 클래이 계정을 추가하면 트랙잭션 처리할때마다 사용 가능
    cav.klay.accounts.wallet.add(walletInstance);
    //setItem은 첫번째 파라미터가 키이고 두번째 파라미터가 밸류
